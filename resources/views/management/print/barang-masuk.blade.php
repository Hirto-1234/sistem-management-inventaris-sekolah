...
<body>
    ...
    <div class="header">
        ...
        <div class="document-info">
            <div class="document-title"><i class="fas fa-box-open"></i>LAPORAN BARANG MASUK</div>
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="20%"><i class="fas fa-box"></i> Nama Barang</th>
                <th width="20%"><i class="fas fa-user-circle"></i> Diinput Oleh</th>
                <th width="20%" class="center"><i class="fas fa-calendar"></i> Tanggal Masuk</th>
                <th width="15%" class="center"><i class="fas fa-arrow-down"></i> Jumlah</th>
                <th width="20%"><i class="fas fa-wallet"></i> Sumber</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="bold">{{ $barang->barang->nama_barang}}</td>
                <td class="bold">{{ $barang->pengguna->nama_lengkap }}</td>
                <td class="center">{{ \Carbon\Carbon::parse($barang->tanggal_masuk)->format('d/m/Y') }}</td>
                <td class="center bold">{{ $barang->jumlah_masuk }}</td>
                <td>{{ $barang->sumber ?? '-' }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="6" class="empty"><i class="fas fa-inbox"></i> Tidak ada data barang masuk</td>
            </tr>
            @endforelse
        </tbody>
        ...
        <tfoot>
            <tr>
                <td colspan="4" style="text-align: right;"><i class="fas fa-calculator"></i> TOTAL</td>
                <td class="center">{{ $barangs->sum('jumlah_masuk') }}</td>
                <td></td>
            </tr>
        </tfoot>
        @endif
